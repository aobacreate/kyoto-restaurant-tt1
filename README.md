...
- **About**: Custom page template (`page-about.php`)
- **News**: Static content written directly in the template (no post type)
...
![screenshot](https://raw.githubusercontent.com/aobacreate/kyoto-restaurant-tt1/main/screenshot.png)
